...
class LocalPlanner(object):
    ...
    def set_global_plan(self, current_plan, stop_waypoint_creation=True, clean_queue=True):
        ...
        :return:
        """
        # print("Setting new global plan with {} waypoints".format(len(current_plan)))
        if clean_queue:
            # print("Cleaning the waypoints queue")
        ...
        # print("New waypoints queue length: {}".format(len(self._waypoints_queue)))
